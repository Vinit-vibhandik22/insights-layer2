...
REQUIRED JSON SCHEMA:
{
  ...
  "architectureMermaid": "VALID Mermaid.js graph TD string ONLY. NO markdown. ONLY use '-->' for arrows (NEVER use '->', '->>', or '=>'). Use simple format: A[Node1] -->|Label| B[Node2]. DO NOT USE QUOTES OR SPACES IN NODE IDS. NO special characters.",
  "systemDesignDetails": {
