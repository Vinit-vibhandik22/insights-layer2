...
REQUIRED JSON SCHEMA (ALL fields mandatory):
{
  ...
  "architectureMermaid": "VALID Mermaid.js graph TD string ONLY. NO markdown. Use simple format: A[\"Node1\"] --> B[\"Node2\"]. Use double-quoted labels for node names with spaces. DO NOT USE SPACES OR SPECIAL CHARACTERS IN NODE IDS.",
  "systemDesignDetails": {
